...
class Page(Base):
    ...
    def get_preview_url(self):
        try:
            ...
            #return reverse('feincms.views.base.preview_handler', kwargs={ 'page_id': self.id })
        except:
            return None
...
class PageAdmin(editor.ItemEditor, list_modeladmin):
    ...
    def _actions_column(self, page):
        ...
        if page.is_active():
            ...
            actions.insert(0, u'<a href="%s" title="%s"><img src="%simg/admin/selector-search.gif" alt="%s" /></a>' % (
                page.get_preview_url(), _('Preview'), django_settings.ADMIN_MEDIA_PREFIX, _('View on site')))
